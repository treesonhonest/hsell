...
public class News implements Serializable {
    ...
    public LocalDate getTopTime() {
        return topTime;
    }

    public News topTime(LocalDate topTime) {
        this.topTime = topTime;
        return this;
    }

    public void setTopTime(LocalDate topTime) {
        this.topTime = topTime;
    }
    ...
    public News createTime(LocalDate createTime) {
    ...
    public News updateTime(LocalDate updateTime) {
